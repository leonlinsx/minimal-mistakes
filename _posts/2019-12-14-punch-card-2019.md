...
<div class="iframe-container">
  <iframe src="https://avoidboringpeople.substack.com/embed" frameborder="0" scrolling="no"> </iframe>   <!-- remove the width and height attributes. Keeping those attributes forces the content to stay at that size regardless of the screen size -->
</div>
