...
It's why [the overall outperformance (alpha) for hedge funds has stagnated,](http://finance.darden.virginia.edu/wp-content/uploads/2019/08/Hedge-Fund-Alpha_09.29.2019.pdf "alpha") as more investors know best practices and frameworks.
...
Everyone else judges you relative to their expectations of you, or relative to someone else. Society is one big [sorting algorithm.](https://en.wikipedia.org/wiki/Sorting_algorithm "sort") \[7\] 
...
2. If I was still in high schoo, I'd be applying to the [Progress Studies for Young Scholars program](https://progressstudies.school/ "progress") with speakers such as Tyler Cowen and Patrick Collison. Seems it's open for adults to audit as well. 

### Question of the month

What’s a controversial idea you’d like to discuss? Reply directly to this email and I might write about it in future newsletters.
...
9. Even the societal rejects like [hikikomoris](https://en.wikipedia.org/wiki/Hikikomori "hiki") will still desire some status, such as commenting online about which anime series is superior and reflects better taste of the viewer
