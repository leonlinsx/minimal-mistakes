...
When I was thinking about this article, I had initially wanted to do a financial model for Notion. However, given the lack of data I'd be making up too many assumptions. I've read they're already profitable with a revenue run-rate of [$30mm](https://www.forbes.com/sites/davidjeans/2020/04/01/buzzy-work-app-notion-hits-2-billion-valuation/#15da831578ec "30"), and I can see them doing 10x that revenue at a 40% margin, while still growing double digits. We'll have to wait on more data, but no wonder people are excited. 
