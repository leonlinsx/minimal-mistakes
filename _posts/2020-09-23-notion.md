...
## 2. Notion's greatest strengths are template options, flexible form, and visual based building
...
**The basic unit of Notion is a block.** Think about how a cell in excel is fundamental to how work is done there. Blocks in Notion are like that, but with a ton more features. Blocks are customisable in both what they display and how they are displayed. They key to remember is that Notion is a visual, design based application, so you should be able to arrange the blocks and alter them according to your needs
