...
And for the other categories:
  ...
  - R&D value creation is ambiguous and difficult to measure
  - A lower cash conversion cycle (better management of working capital) is correlated with a higher return on capital
  - Divestitures are substantial and generally create value
  - The amount companies have spent on buybacks has exceeded dividends for the past decade, except for 2009 \[6\]. Dividends must be reinvested to get the full rate of return; most are not. Buyback returns depend on valuation. 
...
6. Buybacks did not become relevant in the U.S. until 1982
