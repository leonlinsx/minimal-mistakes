...
1. Easier way of managing the email list rather than copying and pasting emails every time, or forgetting to include someone
    ...
    And you can click into each subscriber to see more details as well as edit their subscription
...
2. Easier way for uninterested readers to unsubscribe and less awkwardness compared to emailing me directly \[1\]
    ...
    Though I'd personally prefer if the text was a bit more obvious rather than slightly hidden. Yes, I actually want to make it easier for people to unsubscribe. People don't like spam, and I'd rather not send something to someone who doesn't want it. 
...
5. Potential for greater outreach and perhaps monetisation eventually \[2\], all managed via the platform. The business model is simple as well - a 10% cut once you start charging subscribers
...
1. Customer support so that you don't have to deal with admin yourself
    ...
    I haven't used this yet, but it's nice to have.
...
6. A simple mouse hover text of what they define as 'open' and 'clicks' would also be helpful.
...
6. Will they reconsider adding custom domains, or is it too much of a tech hassle?

Substack offers a free newsletter service that's relatively easy to set up, looks professional, and has helpful analytics of your subscriber base. I've liked using it for my [monthly newsletters](https://avoidboringpeople.substack.com/ "substack") so far, though I'll be sticking with Github Pages for my main website due to the higher degree of customisation offered such as custom domains, separate page layouts, or formatting.
