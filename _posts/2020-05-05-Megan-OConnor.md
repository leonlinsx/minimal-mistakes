...
- What are some problems with schooling from home?
  ...
  - students need to process info in **more digestible units than in person**
  - Taking reference from the 7 min rule from massive open online course (MOOCs) and coursera \[4\], we now need to teach in bite sized pieces of information vs longer lessons in person
...
- We've starting seeing people asking for refunds of college tuition. How do we get away from being focused on credentials? 
  ...
  - and the reason we do that is because there is less data showing learning outcomes for online education, plus we assume there is less personalisation
  - what we need to do then is think about how we
    - do personalisation, 
    - give best in class learning experiences, 
    - have the best cinematography
...
- People will be thinking about "how do I continue to grow as a worker?"
  ...
  - I'd make sure that recommendations are easy for people to follow, rather than leading to analysis paralysis and giving too many options
...
- What form factors do you find most interesting for ed tech?
  ...
  - **in terms of who will win, it will be those who do a great job of onboarding new clients**
    - we're now seeing so many people intrinsically motivated to do certain things
    - products that will win are those that can educate seamlessly   
...
- What are some companies out of left field that might also see opporunities?
  ...
  - another interesting thing is how many students are not reachable by schools 
    - my mom, a teacher, only saw 50% students show up at first. She had to call all of them, and even then only saw 2/3 of students after that
  - what's next is going to be an access provider
  
- How can we use this moment to redesign our approach to public education?
  - we're realising that we're as strong as our environment e.g. the chair, room we're in matters for education
    - perhaps a wework for education, providing a reliable space where people can learn in
  - hope to see increased parent engagement, better understand what students need, and how they can be involved

- Do you see AR/VR elements in edtech?
  - there definitely is an opportunity for sure, but you've got to make sure everyone has access, be able to implement for everyone
  - cater to the lowest access
  
- How do you see the physical layout of classrooms changing?
...
- What advice would you give to an edtech founder?
  - the K-12 sales cycle is already hard and slow. Given how much information overload there is now, you're not going to be able to launch a product into that sale cycle, it'lls be lost in noise
    - your go to market will have to be parent and student focused, come from the bottom up
  - there's also going to be a real critical eye on privacy and compliance
    - if you're buttoned up there, and schools feel they can trust you, you're going to win there
  - be curator of content and an expert and you can win
  
- How does mental health play into this?
  - we know that if you're feeling weird with what's going on, you're not as productive
  - it will become a much more universal conversation, and people will deal with those feelings. It'll become a shared experience and something people don't feel as weird about
  
*LL - I hope that this is the case, though mental health is a hard problem to tackle with a lot of stigma*  
