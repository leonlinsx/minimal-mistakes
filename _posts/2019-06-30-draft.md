...
I try to avoid writing about crypto because I don't really know what's going on and am likely to be misunderstanding something \[1\]. This month I'm breaking that exception because [Facebook's Libra](https://libra.org/en-US/ "Libra") project is so confusing to me I need to rant it out of my system in the first section. The second section is about the SEC suing a crypto company, and the third is career advice I read recently. 

As always, feel free to send to friends you think might be interested in ~~laughing at my summaries~~ reading my writing. Unsubscribe link at the bottom! Anyways, on to Facebook.
...
Guess [special drawing rights](https://www.imf.org/en/About/Factsheets/Sheets/2016/08/01/14/51/Special-Drawing-Right-SDR "SDR") weren't good enough for anyone. But this is an interesting mission though! Imagine a world where you don't have to deal with foreign exchange and can just earn, use, and give funds anywhere. 
