...
We've seen how people benefit from abstracting away different layers of work. The person who programmed sum() doesn't want to spend her time adding up your deposits for you. Neither do you want to program the sum() function does. People focus on the part they want to work on, vastly increasing the possibilities produced.
