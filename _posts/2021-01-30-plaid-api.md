...
We covered a lot today - intuition behind abstraction, APIs, and what Plaid does. The main takeaway then is that there's a lot of stuff that people don't want to do, and a lot of money to be made doing all that stuff. I know the newsletter's titled avoid boring people, but in this case building the boring stuff actually works out great.
