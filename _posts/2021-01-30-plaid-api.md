...
We'll call that library of functions an API. Joshua believes that this is the first use of the term, [in a 1968 paper by Ira Cotton and Frank Greatorex:](https://www.computer.org/csdl/pds/api/csdl/proceedings/download-article/12OmNyRPgFZ/pdf "ira")
