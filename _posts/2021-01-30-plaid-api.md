...
2. [What is an API?](https://www.redhat.com/en/topics/api/what-are-application-programming-interfaces "red hat") by Red Hat
3. [A brief, opinionated history of the API](https://www.youtube.com/watch?v=LzMp6uQbmns "youtube") by Joshua Bloch
4. [How to design a good API and why it matters](https://www.youtube.com/watch?v=heh4OeB9A-c "youtube") by Joshua Bloch
