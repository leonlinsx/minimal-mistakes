...
The concept of abstraction applies outside of programming too. We all work on one layer of a problem, and rely on the lower "levels" being solved for us already. For example, when you're reading this in your email, you don't care how the email service works, just that it does the things you expect.
