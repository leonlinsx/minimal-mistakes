...
*LL - For a framework on how layers interact with each other, check out the [pace layer](https://avoidboringpeople.substack.com/p/wisely-and-slow-they-stumble-that "pace") summary I did a while back. Civilisations consist of multiple layers, each moving at their own speed and interacting with other layers above and below them.*

**Effect on businesses**

- Huge disconnect between the real economy and what the market believes
  - When I look at economic destruction that is permanent, particularly for the time it'll take to rebuild for SMBs, don't think that's fully appreciated
...
*LL - I'm having trouble understanding this as well. The bull case is that all of this job loss was priced in, which is why we saw such a large drop. Also, if everyone is thinking that things are unsafe, that implies consensus is cautious. The bear case is that this is going to be similar to Jan/Feb, where we all knew covid was happening in China but the market still kept going up*
...
- What do you think would be different had this crisis occurred 10 years in the future?
  - Distributed healthcare
    ...
    - What is a high end diagnostic tool for imaging now will be more distributed; everyone will have one the way we have a thermometer
...
- Three things that I would look at seriously
  - In the face of many emerging markets that are struggling, who's coming in to help them. Likely China.
