...
tags: [scale, tech, skill, growth, power law]
published: false
---
...
![post]({{ site.url }}{{ site.baseurl }}/assets/images/min_max_skill/min 1.png)
...
![post]({{ site.url }}{{ site.baseurl }}/assets/images/min_max_skill/min 2.png)
...
![post]({{ site.url }}{{ site.baseurl }}/assets/images/min_max_skill/min 3.jpg)
