...
And you could also say that you can't understand linear algebra unless you learn group theory, how [matrices are a ring](https://www.youtube.com/watch?v=_RTHvweHlhE "ring"), and [why we prefer to work with linear groups](https://www.youtube.com/watch?v=AJTRwhSZJWw "group") \[1\]
...
I do believe there are valid forms of gatekeeping. If you're excluding someone because they would be harmful to the community, that's a reasonable action to take. For example, if you're building a community of people who program in python, and you get a request from someone who's known to hate on python, probably doesn't make sense to accept her in.

More often though, gatekeeping is an attempt by individuals in the "in-group" to maintain their status, as if they somehow lose out the more people know what they know. As I wrote about last month, that's like [shorting the lottery](https://avoidboringpeople.substack.com/p/it-only-goes-up-from-here "short"), and probably a bad idea overall. 

Now, note that the gatekeeper's aren't totally wrong. In fact, their suggestions often make sense in a certain context. For example, it would be tremendously helpful to know linear algebra while studying machine learning. And if you want to become an expert, you have to master all the math reuqired. But artificially preventing people from starting a subject doesn't help anyone.

![post]({{ site.url }}{{ site.baseurl }}/assets/images/gatekeep/gatekeep 5.png)

If you've been biased towards gatekeeping, I'd encourage thinking about whether you're helping the community, or helping yourself. Fields are large enough that the more people are pursuing it, the better. It's rarely, if ever, a zero-sum game. By being open-minded and accepting of beginners, we can grow the entire pie, and have more for ourselves. That's how we can drive progress.

Open more gates. [Be kind.](https://www.youtube.com/watch?v=xnouj9Yz-Gs&feature=youtu.be&t=23 "who")
