...
![post]({{ site.url }}{{ site.baseurl }}/assets/images/Process 4.png)
...
![post]({{ site.url }}{{ site.baseurl }}/assets/images/Process 5.png)
...
![post]({{ site.url }}{{ site.baseurl }}/assets/images/Process 6.png)
...
![post]({{ site.url }}{{ site.baseurl }}/assets/images/Process 7.png)
